...
var resizePizzas = function(size) {
  ...
  var randomPizzasElem = document.getElementById("randomPizzas"),
      allRandomPizzaContainers = document.getElementsByClassName("randomPizzaContainer");
  ...
  function changePizzaSizes(size) {
    // the offsetWidht, dx are the same for all pizza container
...
function updatePositions() {
  ...
  for (i = 0, len = items.length; i < len; i++) {
    ...
    // Changing style.translate can be handled by the compositor alone, so that we can
